...
from parlai.mturk.tasks.dumb_chat.worlds import \
    MTurkMultiAgentDialogWorld, MTurkMultiAgentDialogOnboardWorld
from parlai.agents.dumb_chat.dumb_chat import DumbChatAgent
from task_config import task_config


def main():
    """
    This task consists of one local dumb chat agent and one MTurk agents,
    ...
    mturk_agent_ids = [mturk_agent_1_id]
    ...
    try:
        ...
        def run_conversation(mturk_manager, opt, workers):
            ...
            human_agent_1 = DumbChatAgent(opt=None)
            human_agent_1.id = human_agent_1_id

            world = MTurkMultiAgentDialogWorld(
                opt=opt,
                agents=[human_agent_1, mturk_agent_1]
            )
